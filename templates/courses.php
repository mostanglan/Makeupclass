...
<section id="ourSpecials">
    <div class="container">
        <div class="ourSpecials__wrapper">
            ...
            <div class="ourSpecials__item" onclick="window.location.href='bookings.php?service=Creative Makeup'"> 
                <div class="ourSpecials__item__img">
                    <img src="" alt="">
                </div>
                <div class="ourSpecials__item__info">
                    <h3 class="ourSpecials__item__title"></h3>
                    <h4 class="ourSpecials__item__price"></h4>

                    
                </div>
            </div>
            <div class="ourSpecials__item" onclick="window.location.href='bookings.php?service=Hair Styling'">
                <div class="ourSpecials__item__img">
                    <img src="" alt="">
                </div>
                <div class="ourSpecials__item__info">
            ...
            <div class="serviceGrid__item"onclick="window.location.href='bookings.php?service=Hair Styling'">
                ...
                <div class="serviceGrid__item__info">
                    ...
                    <div class="serviceGrid__item__info">
                        ...
                        <h2 class="serviceGrid__item__price"></h2>
                        
                        </div>
                    </div>
                    <div class="serviceGrid__item" onclick="window.location.href='bookings.php?service=Head and Scalp Massages &cost=Rs.20000'">
                        <div class="serviceGrid__item__img">
                            <img src="" alt="">
                        </div>
                        <div class="serviceGrid__item__info">
...
<!--start-->
    <section id="Grid">
        <div class="container">
            ...
            <div class="serviceGrid__wrapper">
                <div class="serviceGrid__item" onclick="window.location.href='bookings.php?service=Pedicure'">
                    <div class="serviceGrid__item__img">
                        <img src="" alt="">
                    </div>
                    <div class="serviceGrid__item__info">
                    ...
                    <div class="serviceGrid__item" onclick="window.location.href='bookings.php?service=Mehendi'">
                        <div class="serviceGrid__item__img">
                            <img src="" alt="service">
                        </div>
                        <div class="serviceGrid__item__info">
                        ...
                        <div class="serviceGrid__item" onclick="window.location.href='bookings.php?service=Threading'">
                            <div class="serviceGrid__item__img">
                                <img src="" alt="">
                            </div>
                            <div class="serviceGrid__item__info">
    ...
    <section id="Grid">
        <div class="container">
            <div class="serviceGrid__wrapper">
                <div class="serviceGrid__item"onclick="window.location.href='bookings.php?service=Waxing'">
                    <div class="serviceGrid__item__img">
                        <img src="" alt="service">
                    </div>
                    <div class="serviceGrid__item__info">
                    ...
                    <div class="serviceGrid__item"onclick="window.location.href='bookings.php?service=Party Hairstyles'">
                        <div class="serviceGrid__item__img">
                            <img src="" alt="service">
                        </div>
                        <div class="serviceGrid__item__info">
                        ...
                        <div class="serviceGrid__item" onclick="window.location.href='bookings.php?service=Hair Straightening'">
                            <div class="serviceGrid__item__img">
                                <img src="" alt="">
                            </div>
                            <div class="serviceGrid__item__info">
